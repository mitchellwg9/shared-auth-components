...
// Database credentials from Afrihost cPanel
define('DB_HOST', 'localhost');
define('DB_USER', 'tymetrk2y5m0_trackradmin'); // Database username
define('DB_PASS', '!Q@W#E4r5t6y'); // Database password
define('DB_NAME', 'tymetrk2y5m0_tymetrackr'); // Database name
