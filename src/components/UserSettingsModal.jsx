      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        ...
        <div className="p-6">
          <div className="space-y-4">
            {/* Dark Mode */}
            <div className={`flex items-center justify-between p-3 ${localDarkMode ? 'bg-gray-700' : 'bg-gray-200'} rounded-lg border ${localDarkMode ? 'border-gray-600' : 'border-gray-300'}`}>
              <div>
            ...
            {/* Color Theme */}
            <div className={`p-3 ${localDarkMode ? 'bg-gray-700' : 'bg-gray-200'} rounded-lg border ${localDarkMode ? 'border-gray-600' : 'border-gray-300'}`}>
            ...
            {customAppearanceOptions.length > 0 && (
              <div className="space-y-4">
                {customAppearanceOptions.map((option, index) => (
                  <div key={index} className={`p-3 ${localDarkMode ? 'bg-gray-700' : 'bg-gray-200'} rounded-lg border ${localDarkMode ? 'border-gray-600' : 'border-gray-300'}`}>
