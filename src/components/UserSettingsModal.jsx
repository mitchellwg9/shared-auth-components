          ...
          <div className="space-y-4">
            ...
            <div className={`p-3 ${currentDarkMode ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg`}>
              <div className="flex items-center justify-between">
                <div>
                  <h4 className={`font-medium text-sm ${currentDarkMode ? 'text-gray-200' : 'text-gray-900'}`}>Color Theme</h4>
                  <p className={`text-xs ${currentDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Choose a color theme for your app</p>
                </div>
                <select
                  value={currentTheme}
                  onChange={(e) => {
